...
public class PictureGridTabViewActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_picture_grid_tab_view, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            // Return a InflatedImageFragment (defined as a static inner class below).
            //return InflatedImageFragment.newInstance(position);
